...
public class LoggingBufferConcurrencyTest {
    ...
    @Test
    public void shouldProcessEventsFastAndNotFallDown() throws Exception {
        ...
        List<StopOnErrorCallable<Void>> modifiers = new ArrayList<>();
        ...
        ConcurrencyTestRunner<?, ?> runner =
                new ConcurrencyTestRunner<Object, Object>( modifiers, readers, condition, 5000 );
    ...
    private class Reader extends StopOnErrorCallable<StringBuffer> {
      ...
      @Override
      StringBuffer doCall() throws Exception {
